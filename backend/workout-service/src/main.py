...
from src.api.routes import router as workout_router
import logging
...
app = FastAPI(
    ...
    description="Workout Service for MealUp - Manage exercises, trainings, and workout plans",
    lifespan=lifespan
)
...
@app.get("/")
async def root():
    return {"message": "Workout Service is running", "version": settings.VERSION}
